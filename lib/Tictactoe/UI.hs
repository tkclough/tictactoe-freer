...
-}
go :: IO ()
go = M.simpleMain . setAvailableSize (8,8) .
                     vBox $ 
                     [hBox [xWidget, B.vBorder, xWidget, B.vBorder, xWidget],
                      B.hBorder,
                      hBox [xWidget, B.vBorder, oWidget, B.vBorder, xWidget],
                      B.hBorder,
                      hBox [xWidget, B.vBorder, xWidget, B.vBorder, xWidget]]